...
/**
 * CrowdCanvas — animated sprite-sheet crowd walking across the bottom.
 * Sprite sheet: public/images/peeps/all-peeps.png (15 cols × 7 rows)
 * Adapted from skiper39 / https://codepen.io/zadvorsky/pen/xxwbBQV
 * Illustrations: openpeeps.com
 */
export default function CrowdCanvas({ src, rows = 15, cols = 7 }) {
